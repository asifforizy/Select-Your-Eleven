...
const Hero = () => {
    return (
        <div className='banner rounded-xl items-center p-20 mb-20' >
            ...
            <h1 className=' text-3xl lg:text-4xl font-bold  text-center mt-5'>Assemble Your Ultimate Dream 11 Cricket Team</h1>
            <p className=' text-center lg:text-xl'>Beyond Boundaries Beyond Limits</p>
